...
def signup():
    ...
    if role == UserRole.LECTURER:
        ...
        add_lecturer(title=title, staff_id=staff_id, faculty=faculty, user_id=new_user_id)
    elif role == UserRole.STUDENT:
        student_id = data.get('studentId')
        public_key = data.get('public_key', None)
        add_student(student_id=student_id, public_key=public_key, user_id=new_user_id)
