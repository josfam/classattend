...
const SideBarBtn = ({ text, Icon, ...props }: SideBarBtnProps) => {
  return (
    <button {...props} className="btn-pri border-t-w-3 border-t-1 flex h-14 flex-row items-center justify-center gap-6 rounded-none border-t-sky-500 bg-sky-700 text-xl">
